@echo off
echo do you hate rthro head?
pause
echo wow you do im shutting you off
pause
...
echo applicationname="rthro head" >> bsod.hta

echo version="R.H" >> bsod.hta
...
echo ^<p^>A problem has been detected and windows has been shutdown to damage to your computer.^</p^> >> bsod.hta

echo. >> bsod.hta

echo ^<p^>Do_Not_Hate_On_Rthro_Head

UAL^</p^> >> bsod.htaecho. >> bsod.hta

echo if this happens to you say sorry to rthro head^</p^> >> bsod.hta
